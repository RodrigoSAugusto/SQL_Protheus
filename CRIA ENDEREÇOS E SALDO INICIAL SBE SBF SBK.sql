...
--rollback
--######################
--INSERE NOS ENDEREÇOS

--BEGIN TRANSACTION INSERT INTO SBF010 (BF_FILIAL,BF_PRODUTO,BF_LOCAL,BF_PRIOR,BF_LOCALIZ,BF_LOTECTL,BF_QUANT,BF_QTSEGUM,R_E_C_N_O_)
SELECT 
B8_FILIAL BF_FILIAL,
...
--######################
--INSERE NOS SALDOS INICIAIS DOS ENDEREÇOS
